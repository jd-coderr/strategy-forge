...
<div className="metrics">
  ...
  <p>TOP CMC SKILL....... {getCmcTopSkill()}</p>
  <p>COMPARISON ROLE..... EXTERNAL MARKET INTELLIGENCE LAYER</p>
  <p>STRATEGY ROLE....... PRIVATE BACKTESTED EXECUTION MODEL</p>
  <p>COMPETITION VALUE... SHOWS PRIVATE OPTIMIZER + CMC SKILL HUB WORKFLOW</p>
  <p>DECISION IMPACT..... RESEARCH CONFIRMATION ONLY - DOES NOT OVERRIDE BACKTEST</p>
</div>
  </>
)}
